...
| 2026-09-05 | Claude (sessão do plano) | `bash scripts/smoke-videos.sh --skip-multipart` | seção 8e da Fase 06 (like único, comentário + resposta, profundidade, exclusão 403, auto-inscrição 409, inscrição, agregado social) — ver resultado no log da execução |
